...
<div class="termynal" data-termynal data-ty-typeDelay="40" data-ty-lineDelay="700">
    ...
    <span data-ty>Successfully installed termynal</span>
</div>

## Opção 2: Code Block (console)
```console
...
!!! info "Guia de Instalação"
    Se você ainda não instalou o Python e o VSCode, consulte nosso [Guia de Instalação](setup/instalacao_windows.md).
